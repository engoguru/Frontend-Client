            ...
            {orderUserSpecific.slice().reverse().map((order) => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div>
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${order.orderStatus === 'Completed'
                ...
                <div className="mb-4">
                  <div className="text-sm text-gray-600">
                    ...
                    <div className="ml-2 mt-1 space-y-1">
                      ...
                      <p><strong>Address Line 1:</strong> {order.deliveryAddress.address_line1}</p>
                      {order.deliveryAddress.address_line2 && (
                        <p><strong>Address Line 2:</strong> {order.deliveryAddress.address_line2}</p>
                      )}
                      <p>
                        <strong>City:</strong> {order.deliveryAddress.city}, <strong>State:</strong> {order.deliveryAddress.state} - <strong>Pincode:</strong> {order.deliveryAddress.pincode}
                      </p>
                      <p><strong>Country:</strong> {order.deliveryAddress.country}</p>
                      <p><strong>Address Type:</strong> {order.deliveryAddress.address_type}</p>
                    </div>
                  </div>
